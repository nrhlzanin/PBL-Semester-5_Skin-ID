# Generated by Django 5.1.3 on 2024-12-07 00:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_sign', models.CharField(blank=True, max_length=10, null=True)),
                ('currency', models.CharField(blank=True, max_length=10, null=True)),
                ('product_link', models.URLField(blank=True, max_length=1000, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
            options={
                'db_table': 'Product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skintone_description', models.CharField(blank=True, max_length=1000, null=True)),
